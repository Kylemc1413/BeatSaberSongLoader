...
namespace SongCore.Utilities
{
   ...
   //             Utilities.Logging.Log(file);
            ...
            return Utils.CreateSha1FromString(combinedData + level.customLevelPath) + "∎" + string.Join("∎", level.songName, level.songSubName, level.levelAuthorName, level.beatsPerMinute.ToString()) + "∎";
