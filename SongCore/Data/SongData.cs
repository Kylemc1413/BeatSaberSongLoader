      ...
      //      Utilities.Logging.Log("SongData full Ctor");
        ...
        public ExtraSongData(string levelID, string songPath)
        {
            ...
            try
            {
                ...
                if (info.ContainsKey("_customEnvironment")) customEnvironmentName = (string)info["_customEnvironment"];
                if (info.ContainsKey("_customEnvironmentHash")) customEnvironmentHash = (string)info["_customEnvironmentHash"];
                ...
                foreach (JObject diffSet in diffSets)
                {
                    ...
                    foreach (JObject diffBeatmap in diffBeatmaps)
                    {
                        ...
                        {
                            if(diffBeatmap["_colorLeft"] != null)
                            {
                        ...
                        {
                            if (diffBeatmap["_colorRight"] != null)
                            {
